...
#
# docker run --restart unless-stopped --name gcdns-genbot --env cGCDNSProject=adhoc-dev -v /var/run/docker.sock:/var/run/docker.sock:ro -v /var/local/dockprox:/var/local/dockprox -d unxsio/gcdns-genbot
